# -*- coding: utf-8 -*-
"""
Created on Mon Oct  2 09:48:32 2023
...
# df = pd.read_csv("AWS FAQ CSV.csv",header=None)
# df.columns=["text"]
...
def get_embedding(text):
  response = openai.Embedding.create(
    model=EMBEDDING_MODEL,  # Make sure EMBEDDING_MODEL is defined somewhere
    input=text
  )
  return response['data'][0]['embedding']  # Assuming the embedding is in the 'data' field

# df['embedding'] = df['text'].apply(get_embedding)
# df.head()
# df.to_pickle("ecv_billing_qa.pk")
