...
if __name__ == "__main__":
    ...
    # 初始化OpenAI
    openai.api_key = "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"  # 請填入你的OpenAI API金鑰

    # 載入資料
    df = pd.read_pickle('ecv_billing_qa.pk')

    # 設定Bot Framework Adapter
    botsettings= BotFrameworkAdapterSettings("1ee97037-cd6f-4c54-931d-4030151897d8", "Kxm8Q~Sg_~DEflbxYzoV5DxQFMSjSWMtv9X9uac.")
    adapter = BotFrameworkAdapter(botsettings)
